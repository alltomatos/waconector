...
e suite de contrato prontos; adapters **WAHA**, **Evolution GO** (F1), **uazapi**, **Z-API** e
**Wuzapi** (F2) implementados e verificados. A API pública pode mudar entre minors até a v1.0.
