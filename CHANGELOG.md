...
- 00b91e7: Capabilities novas `messages.download` e `channels.getMessages`/`markViewed`/`reactToPost` — ver
...
- b5380ed: Adapter **izapia** (`waconector/izapia`) — nono provider suportado, SaaS multi-tenant próprio
